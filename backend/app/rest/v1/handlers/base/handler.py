...
_DEFINED_REST_HANDLERS: dict[type[Command], type["Handler[Any, Any, Any]"]] = {}
...
class Handler[C: Command, R: StructDTO | None, X: StructDTO | None](ABC):
    ...
    def __init_subclass__(cls, /, type_: HandlerType = HandlerType.WRITE) -> None:
        ...
        if not getattr(cls, "__abstractmethods__", None):
            _DEFINED_REST_HANDLERS[cls.command_dto] = cls
...
def get_defined_rest_handlers() -> dict[type[Command], type["Handler[Any, Any, Any]"]]:
    return _DEFINED_REST_HANDLERS
